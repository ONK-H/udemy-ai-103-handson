...
5. Foundry ポータル（https://ai.azure.com ）の **Build → Knowledge / Tools / Agents** で、選んだ部品の在り処を確認する（作成は不要）。接続（connection）は **Manage → Project details → Connected resources** にある。
